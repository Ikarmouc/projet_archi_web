...
| 2   | En tant qu'utilisateur, je souhaite pouvoir consulter un article spécifique                                 | 2                 | l'affichage des informations d'un article doit être ergonomique et doit contenir les eventuels evenements a venir                                    | Les articles doivent etre sous forme de liste  |  |
| 3   | En tant qu'administrateur je souhaite pouvoir m'identifier sur le site afin d'administrer le site            | 5                 | Le systeme d'identification est le meme que pour un utilisateur classique                                                                             | L'interface de connexion doit etre ergonomique |  |
| 4   | En tant qu'administrateur je souhaite pouvoir modifier les informations d'un article sur une technologie     | 4                 |                                                                                                                                                       |                                                |  |
| 5   | En tant qu'administrateur, je souhaite pouvoir supprimer des articles sur des technologies scientifiques     | 4                 | si un article comporte des evenements ainsi que des réservations, alors les evenements et les réservations en lien avec l'article seront supprimés |                                                |  |
| 6   | En tant qu'administrateur, je souhaite pouvoir ajouter des articles en lien avec les sciences                | 4                 |                                                                                                                                                       | Le formulaire doit etre complet                |  |
| 7   | En tant qu'utilisateur, je souhaite pouvoir m'identifier sur le site afin d'acceder a mon compte utilisateur | 5                 | Le compte utilisateur peut etre crée s'il n'existe pas.<br /><br /><br><br />les mots de passe doivent contenir un minimum de 8 characteres          |                                                |  |
| 8   | En tant qu'administrateur, je souhaite pouvoir gérer les utilisateurs du site                               | 3                 |                                                                                                                                                       |                                                |  |
...
| 13  | En tant qu'utilisateur, je souhaite pouvoir consulter mes réservations                                      | 2                 |                                                                                                                                                       |                                                |  |
| 14  | En tant qu'utilisateur,  je souhaite pouvoir modifier mes réservations                                      | 2                 |                                                                                                                                                       |                                                |  |
| 15  | En tant qu'administrateur,  je souhaite pouvoir gerer les evenements                                         | 4                 |                                                                                                                                                       |                                                |  |
